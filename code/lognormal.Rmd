...
We define a lognormal population. See this [**blog post**](https://msalganik.wordpress.com/2017/01/21/making-sense-of-the-rlnorm-function-in-r/) on how to use the `lnorm` functions in R.

...
Reporting correlation results conditional on statistical significance (p<=0.05) leads to inflated effect size estimation in the literature. This estimation bias increases with lower sample sizes.
...
### Plot KDE of correlation estimates p<=0.05
```{r}
# get data
...
### Plot correlation estimates p<=0.05
```{r}
# get data
...
```{r eval=FALSE}
require(Cairo)
CairoPDF(file=('./figures/figure_samp_dist.pdf'),width=15,height=12)
...
cowplot::plot_grid(p.sd,  p.sd04, p.csd, p.csd04,
                          ...
                          align = "h")
# save figure
# ggsave(filename=('./figures/figure_samp_dist.pdf'),width=15,height=12)
dev.off()
```
...
cowplot::plot_grid(p.precision,  p.replication,
                          ...
                          align = "h")
# save figure
ggsave(filename=('./figures/figure_prec_rep.pdf'),width=7,height=10)
```
